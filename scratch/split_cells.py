...
def split_filtering_cells(nb_path):
    ...
    new_cells = [
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["### 1.3.1.2.A - Filtering Logic & Configuration\n", "Define constraints and the core cleaning function."]
        },
        {
            "cell_type": "code",
            "metadata": {},
            "outputs": [],
            "source": [
                "# 1.3.1.2.A - Filtering Logic & Configuration\n",
                "import pandas as pd\n",
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["### 1.3.1.2.B - Batch Execution\n", "Run the filtering process across all standardized tables."]
        },
        {
            "cell_type": "code",
            "metadata": {},
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["### 1.3.1.2.C - Quality Report\n", "Display detailed statistics of the cleaning process."]
        },
        {
            "cell_type": "code",
            "metadata": {},
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["### 1.3.1.2.D - Overall Data Health Visualization\n", "Visual summary of data retention."]
        },
        {
            "cell_type": "code",
            "metadata": {},
            "outputs": [],
            "source": [
                "# 1.3.1.2.D - Overall Data Health Visualization\n",
                ...
                "fig_pie.show()\n",
                "print(f\"Summary: {total_orig - total_clean:,} rows filtered out across all datasets.\")\n"
            ]
        }
    ]
    ...
    if idx_to_replace != -1:
        # Replace the single cell with the new list of cells
        nb['cells'] = nb['cells'][:idx_to_replace] + new_cells + nb['cells'][idx_to_replace+1:]
        with open(nb_path, 'w', encoding='utf-8') as f:
            json.dump(nb, f, indent=1, ensure_ascii=False)
        print("Successfully split filtering section into smaller cells.")
    else:
        print("Target cell not found.")

if __name__ == "__main__":
    split_filtering_cells("Data.ipynb")
