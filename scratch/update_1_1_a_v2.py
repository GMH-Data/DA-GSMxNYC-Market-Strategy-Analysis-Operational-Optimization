...
cell['source'] = [
    ...
    "\n",
    "# Robust fix for FHV: Set to 0 for months before it had consistent data to avoid huge % jumps\n",
    ...
    "\n",
    "# Calculate Mean and Median (excluding the anomalous 0s for FHV in early period if desired, \n",
    "# but here we take the average of the rates shown in the table)\n",
    ...
    "}, index=['MEAN (%)', 'MEDIAN (%)'])\n",
    "\n",
    "# 1. Display Summary Statistics First\n",
    "print(\"\\n--- 1.1.A GROWTH STATISTICS SUMMARY (2016-2018) ---\")\n",
    "display(stats_df.round(2))\n",
    "\n",
    "# 2. Display Detailed Table with Stats appended\n",
    "df_display = pd.concat([df_monthly_growth_rate_pct, stats_df.round(2)])\n",
    "print(\"\\n--- 1.1.A DETAILED MONTHLY GROWTH RATE TABLE ---\")\n",
    "display(df_display)\n",
    "\n",
