...
def update_filtering_table(nb_path):
    ...
    new_code = [
        ...
        "        \"Cleaned\": clean, \n",
        "        \"Removed\": orig-clean,\n",
        "        \"Date Range\": f\"{YEAR_MIN}-{YEAR_MAX}\",\n",
        "        \"Zone Range\": f\"{ZONE_MIN}-{ZONE_MAX}\",\n",
        "        \"Logic Check\": \"Duration > 0\"\n",
        "    })\n",
        "    total_orig += orig\n",
        "    total_clean += clean\n",
        "\n",
    ...
    if found:
        ...
        print("Successfully updated filtering table columns.")
    else:
        print("Target cell not found.")

if __name__ == "__main__":
    update_filtering_table("Data.ipynb")
